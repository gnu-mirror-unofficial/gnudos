...
\entry {Bottom view}{4}
\initial {C}
\entry {Command line export}{3}
\initial {D}
\entry {Directory view}{4}
\initial {E}
\entry {Edit menu}{5}
\entry {Exporting from the command line}{3}
\initial {F}
...
\entry {Menus}{4}
\initial {N}
\entry {No log information}{3}
\initial {O}
\entry {Overview}{1}
\initial {P}
\entry {Prime main window}{3}
...
\entry {Why to use it}{2}
\entry {Why to use Prime}{2}
\entry {Working around with menus}{4}
